...
class DDPG_Multi_Agent():
    """Interacts with and learns from the environment."""
    
    def __init__(self, state_size, action_size, n_agents = 1, random_seed = 1):
    ...
    def act(self, state, add_noise=True):
        ...
        '''
        if add_noise:
            for local_param in zip(self.actor_local.parameters()):
                local_param += self.noise.sample_parameters()
        '''
